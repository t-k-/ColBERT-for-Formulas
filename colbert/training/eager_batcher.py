...
class EagerBatcher():
    def __init__(self, args, rank=0, nranks=1):
        ...
        self.query_tokenizer = QueryTokenizer(args.query_maxlen, model=args.model, tokenizer_path=args.model_path)
        self.doc_tokenizer = DocTokenizer(args.doc_maxlen, model=args.model, tokenizer_path=args.model_path)
